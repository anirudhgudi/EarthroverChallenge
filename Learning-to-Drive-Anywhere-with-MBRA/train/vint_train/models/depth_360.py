...
class Depth_est:
    def __init__(self, h_size, w_size, bin_size, batch_img, device, aug):
        ...
        path = os.path.join("/home/mango/Earthrover/Learning-to-Drive-Anywhere-with-MBRA/MBRA_project_models/depthest_ploss/", "encoder.pth")
        ...
        path = os.path.join("/home/mango/Earthrover/Learning-to-Drive-Anywhere-with-MBRA/MBRA_project_models/depthest_ploss/", "depth.pth")
